...
gym --workspace ${workspace_path} --scheme ${scheme} --clean --use_legacy_build_api true --configuration ${configuration} --archive_path ${archive_path} --export_method ${export_method} --output_directory ${output_path} --output_name ${ipa_name}
#gym
